// FILE: server.js (Final Corrected Version with All Features)
...
// CORRECTED AND FINAL: This endpoint now correctly handles FormData for updates.
app.put('/api/artists/:id', upload.single('image'), async (req, res) => {
    try {
        const { name, bio, twitter_url, instagram_url, facebook_url } = req.body;
        // If a new file was uploaded, req.file will exist. Otherwise, it will be null.
